...
Yf_freq = Total_number_of_Y_in_female/(Total_number_of_Y_in_female+Total_number_of_S_in_female)
Sf_freq = Total_number_of_S_in_female/(Total_number_of_Y_in_female+Total_number_of_S_in_female)
Ym_freq = Total_number_of_Y_in_male/(Total_number_of_Y_in_male+Total_number_of_S_in_male)
Sm_freq = Total_number_of_S_in_male/(Total_number_of_Y_in_male+Total_number_of_S_in_male)
...
if Sm_freq == 0.0000:
    ...
    with open("result.txt", "a") as f:
        f.write("Y and S coexist\n")

fig, (axL, axR) = plt.subplots(nrows=2, ncols=1, constrained_layout=True)

axL.plot(n, Yf_f, 'royalblue', label='$Y$ chromosome')
axL.plot(n, Sf_f, 'indigo', label='$Y^{S}$ chromosome')
axL.legend(loc='upper center')
axL.set_xlim(0, generations)
axL.set_ylim(0, 1)
axL.set_ylabel("frequency\nin female")

axR.plot(n, Ym_f, 'royalblue', label='$Y$ chromosome')
axR.plot(n, Sm_f, 'indigo', label='$Y^{S}$ chromosome')
axR.legend(loc='upper center')
axR.set_xlim(0, generations)
axR.set_ylim(0, 1)
axR.set_ylabel("frequency\nin male")
axR.set_xlabel("Generations")

#axB.plot(n, N_female, 'r', alpha=0.5)
#axB.plot(n, N_male, 'b', alpha=0.5)
#axB.set_xlim(0, generations)
#axB.set_ylim(0, population)
#axB.set_ylabel("female/male")

#axP.plot(n, N_1YSinF, 'lightgrey', label='1 Y/S chromosome')
#axP.plot(n, N_2YSinF, 'grey', label='2 Y/S chromosomes')
#axP.legend(loc='upper center')
#axP.set_xlim(0, generations)
#axP.set_ylim(0, population/2)
#axP.set_ylabel("# of females")

#axQ.plot(n, N_1YSinM, 'lightgrey', label='1 Y/S chromosome')
#axQ.plot(n, N_2YSinM, 'grey', label='2 Y/S chromosomes')
#axQ.plot(n, N_3YSinM, 'black', label='3 Y/S chromosomes')
#axQ.legend(loc='upper center')
#axQ.set_xlim(0, generations)
#axQ.set_ylim(0, population/2)
#axQ.set_ylabel("# of males")
#axQ.set_xlabel("Generations")
